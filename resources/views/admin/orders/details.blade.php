                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <tr>
                                ...
                                @else
                                    {{ link_to_route('order.confirmed','Confirm', $order->id, ['class'=>'btn btn-success btn-sm']) }}
                                @endif  </td>
                            </tr>
                        </tbody>
                    </table>
                                ...
                                @foreach ($order->products as $product)
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <img src="{{ url('assets/uploads') . '/' . $product->productimage }}" alt="{{$product->productname}}" style="width: 2em" >
                                        </a>
                                        </td>
                                    </tr>
                                    </table>
